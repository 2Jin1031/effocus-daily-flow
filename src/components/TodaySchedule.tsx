            ...
            <div key={schedule.id} className={`${isPast ? 'opacity-50' : ''} ${schedule.isAutoGenerated ? 'border-l-4 border-gray-300 pl-2 ml-2' : ''}`}>
              <div className="flex items-center space-x-4">
                <div className="flex flex-col items-center">
                  <div className={`w-12 h-12 ${schedule.color} rounded-full flex items-center justify-center text-white text-lg shadow-md ${isPast ? 'grayscale' : ''} ${schedule.category === 'travel' ? 'border-2 border-dashed border-gray-400' : ''}`}>
                    {schedule.icon}
                  </div>
